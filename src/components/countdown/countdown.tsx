...
public handleSubmit = (e) => {
  ...
  axios.post('https://dev.flipr.co.in/api/userprofile/create'
    , {
...
<div className="count-top">
    <div className="countdown-cl">
        <FlipClock units={[ { sep: '' , title: 'days' , type: 'days' , }, { sep: ' ' , title: 'hour' , type: 'hours' , }, { sep: ':' , title: 'minute' , type: 'minutes' , }, { sep: ':' , title: 'sec',  type: 'seconds' , } ]} type="countdown" count_to="2019-06-03 00:00:00" />
    </div>
    <div className="banner-text">
        <h2>Code Bootcamp 03 June 2019</h2>
